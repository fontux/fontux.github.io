 ...
 {var e, t, r;
  ...
  ({1:[function (e, t, r)
	...
	{var r = [{type:"text", data:e}];
	 ...
	 return r};
	var i = function (e, t) {var r = a(e, t);
				 ...
				 {if (r[i].type==="text")
				  {n.appendChild(document.createTextNode(r[i].data))}
					...
					var l = r[i].data;
					try{katex.render(l, o, {displayMode:r[i].display})}
					catch (f)
